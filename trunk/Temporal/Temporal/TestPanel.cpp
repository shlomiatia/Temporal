...
animation = new SpriteGroup();
spritesheet->add(animation);
animation->add(new Sprite(Rect(24.5, 342, 22, 107), Vector(-6, 49)));
animation->add(new Sprite(Rect(67, 348, 25, 89), Vector(-8, 40)));
animation->add(new Sprite(Rect(109, 348.5, 27, 90), Vector(-3, 31)));
animation->add(new Sprite(Rect(150.5, 346.5, 34, 92), Vector(-2, 20)));
animation->add(new Sprite(Rect(200.5, 348.5, 46, 82), Vector(5, 14)));
...
animation->add(new Sprite(Rect(600, 344.5, 57, 46), Vector(15, -21)));
animation->add(new Sprite(Rect(660, 344.5, 53, 48), Vector(20, -22)));
animation->add(new Sprite(Rect(727.5, 338.5, 54, 58), Vector(10, -26)));
animation->add(new Sprite(Rect(787, 332.5, 53, 64), Vector(17, -32)));
animation->add(new Sprite(Rect(843, 330, 51, 69), Vector(19, -31)));
animation->add(new Sprite(Rect(896, 324, 31, 79), Vector(3, -37)));
animation->add(new Sprite(Rect(937, 324.5, 23, 80), Vector(1, -39)));
// JumpForwardStart - 9
animation = new SpriteGroup();
spritesheet->add(animation);
