...
namespace Temporal
{
	void Animation::add(Hash sceneNodeID, float duration, const Vector& translation, float rotation)
	{
		...
		SceneNodeSample* sceneNodeSample = new SceneNodeSample(startTime, duration, translation, rotation);
